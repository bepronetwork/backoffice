...
import PointsAddOn from './PointsAddOn';
...
class PointsWidget extends React.Component{
    ...
    render = () => {
        ...
        return (
            <TabContainer>
                <Paragraph style={{ marginBottom: 15 }}>Edit logo, name and ratio of the Points AddOn</Paragraph>
                <Row>
                    <LockWrapper hasPermission={isSuperAdmin}>
                        <PointsAddOn wallet={wallet}/>
                    </LockWrapper>
                </Row>
            </TabContainer>
        )
...
export default connect(mapStateToProps)(PointsWidget);