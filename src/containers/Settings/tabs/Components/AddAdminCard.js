...
class AddAdminCard extends Component {
    ...
    render() {
        ...
        return (
            ...
            <CardBody className="dashboard__card-widget" style={{ width: 305, minHeight: 300, padding: "50px 20px", borderRadius: "10px", border: "solid 1px rgba(164, 161, 161, 0.35)", backgroundColor: "#fafcff", boxShadow: "none" }}>
